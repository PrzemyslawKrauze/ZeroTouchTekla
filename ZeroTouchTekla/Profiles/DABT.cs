    ...
    public class DABT : Element
    {
        ...
        public void FirstBeamProperties(Beam beam)
        {
            ...
            if (firstProfileName.Contains("V"))
            {
                ...
                if (firstProfileName.Contains("SK"))
                {
            ...
            else
            {
                ...
                BackwallTopHeight2 = BackwallTopHeight;
        ...
        public static double Height4;
        public static double FrontHeight4;
        public static double BackwallTopHeight4;
        public static double BackwallBottomHeight4;
        public static double Length;
        public static double Length2;
        public static double Length3;
